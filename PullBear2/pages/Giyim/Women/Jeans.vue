...
const handleFilterChange = (filter4: string): void => {
  selectedFilter.value = filter4
  productStore.setFilters('jeans', 'women', filter4)
}
...
onMounted(async () => {
  try {
    ...
    productStore.setFilters('jeans', 'women', 'all')
