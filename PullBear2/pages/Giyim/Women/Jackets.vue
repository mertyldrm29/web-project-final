...
const handleFilterChange = (filter5: string): void => {
  selectedFilter.value = filter5
  productStore.setFilters('jackets', 'women', filter5)
}
...
onMounted(async () => {
  try {
    ...
    productStore.setFilters('jackets', 'women', 'all')
