...
const handleFilterChange = (filter3: string): void => {
  selectedFilter.value = filter3
  productStore.setFilters('tshirts', 'women', filter3)
}
...
onMounted(async () => {
  try {
    ...
    productStore.setFilters('tshirts', 'women', 'all')
